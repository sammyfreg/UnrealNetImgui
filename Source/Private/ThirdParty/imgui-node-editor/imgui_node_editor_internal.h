...
struct FringeScaleScope
{
    ...
    FringeScaleScope(float scale)
        : m_LastFringeScale(ed::ImFringeScaleRef(ImGui::GetWindowDrawList()))
    {
        ed::ImFringeScaleRef(ImGui::GetWindowDrawList()) = scale;
    }

    ~FringeScaleScope()
    {
        ed::ImFringeScaleRef(ImGui::GetWindowDrawList()) = m_LastFringeScale;
    }
