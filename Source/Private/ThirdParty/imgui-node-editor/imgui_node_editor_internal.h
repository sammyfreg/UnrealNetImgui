...
static inline float& ImFringeScaleRef_UNITY_FIX(ImDrawList* drawList) // @EDIT Unity build fix
{
...
struct FringeScaleScope
{
    ...
    FringeScaleScope(float scale)
        : m_LastFringeScale(ImFringeScaleRef_UNITY_FIX(ImGui::GetWindowDrawList())) // @EDIT Unity build fix
    {
        ImFringeScaleRef_UNITY_FIX(ImGui::GetWindowDrawList()) = scale; // @EDIT Unity build fix
    }

    ~FringeScaleScope()
    {
        ImFringeScaleRef_UNITY_FIX(ImGui::GetWindowDrawList()) = m_LastFringeScale; // @EDIT Unity build fix
    }
